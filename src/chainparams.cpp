...
public:
    CMainParams() {
        ...
        consensus.DIP0001Height = 400000;
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nStartTime = 1559347201; // June 1st, 2019
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nTimeout = 1590969601; // June 1st, 2020
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nWindowSize = 4741;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nThreshold = 3793; // 80% of 4741
...
public:
    CTestNetParams() {
        ...
        // Deployment of DIP0001
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nStartTime = 1551398401; // Mar 1st, 2019
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nTimeout = 1583020801; // Mar 1st, 2020
